...
SELECT models.name AS model_name, brands.name AS brand_name, headquarters FROM models INNER JOIN brands ON models.brand_id = brands.brand_id 
...
SELECT COUNT(name) FROM models WHERE brand_id='for';
...
SELECT models.year AS year, models.name AS name, models.model_id AS model_id, awards.name AS name FROM models LEFT OUTER JOIN awards ON models.model_id = awards.winner_id WHERE models.year >= 1964;
...
SELECT b.name, b.founded FROM brands AS b LEFT JOIN models AS m ON b.brand_id = m.brand_id WHERE m.name IS NULL;
...
SELECT m.name, m.year FROM models AS m INNER JOIN brands AS b ON b.brand_id = m.brand_id WHERE m.year = ANY (SELECT founded FROM brands); 